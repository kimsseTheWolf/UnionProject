...
class create_project ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Create a new project...", pos = wx.DefaultPosition, size = wx.Size( 505,350 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.btn_okOK.Bind( wx.EVT_BUTTON, self.create_project )
