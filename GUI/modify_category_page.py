...
###########################################################################
## Class ModifyCategoryWindow
###########################################################################

class ModifyCategoryWindow ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Modify Category...", pos = wx.DefaultPosition, size = wx.Size( 494,334 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		# Connect Events
		self.Bind( wx.EVT_ACTIVATE, self.setInputValue )
		self.Bind( wx.EVT_INIT_DIALOG, self.setInputValue )
		self.btn_ynSelectCancel.Bind( wx.EVT_BUTTON, self.exit_window )
		self.btn_ynSelectOK.Bind( wx.EVT_BUTTON, self.modify_category )
